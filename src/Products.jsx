...
function Products() {
  /*
  whenever we comeback from a page to this page, then all the parameters will reset to its initial state, Thus we need to save all 
  these filters inside the url using the react-router-dom 
  ...
  */
  ...
  const [searchParams, setSearchParams] = useSearchParams({
    ...
    limit: 4,
    q: "",
  }); // works same as useState

  const limit = parseInt(searchParams.get("limit") || 0); // because they both are present in string format
